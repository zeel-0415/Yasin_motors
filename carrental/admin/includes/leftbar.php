<nav class="ts-sidebar">
    <ul class="ts-sidebar-menu">
        ...
        <li><a href="main.php"><i class="fa fa-wrench"></i> Maintenance of Cars</a></li>
        <li>
    <a href="#"><i class="fa fa-user"></i> Drivers</a>
    <ul>
        <li><a href="dri.php">Assign Drivers</a></li>
        <li><a href="d-info.php">Driver Information</a></li> <!-- New option for driver information -->
    </ul>
</li>
