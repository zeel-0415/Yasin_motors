...
$sql7 = "SELECT COUNT(id) as maintenance_count FROM tblvehicles WHERE maintenance_status = 'In Maintenance'";
$query7 = $dbh->prepare($sql7);
$query7->execute();
$maintenanceResults = $query7->fetch(PDO::FETCH_ASSOC);
$maintenanceCount = $maintenanceResults['maintenance_count'];
?>
											<div class="stat-panel-number h1 "><?php echo htmlentities($maintenanceCount);?></div>
											<div class="stat-panel-title text-uppercase">Vehicles In Maintenance</div>
										</div>
									</div>
									<a href="manage-maintenance.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
								</div>
							</div>
						</div>
					</div>
